...
extension UIColor {
    public static func generate(rgb: CGFloat, alpha: CGFloat = 1.0) -> UIColor {
        return UIColor(red: rgb/256, green: rgb/256, blue: rgb/256, alpha: alpha)
    }
    
    public static func generate(red r: CGFloat, green g: CGFloat, blue b: CGFloat, alpha a: CGFloat = 1.0) -> UIColor {
